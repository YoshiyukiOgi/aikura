...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}[hidden]{display:none!important}body{margin:0}h1,h2,h3,p{margin:0}
    ...
    header h1{font-size:15px;font-weight:800;padding-left:10px;letter-spacing:.02em}main{padding:12px 18px 88px}.layout{display:grid;grid-template-columns:390px minmax(640px,1fr);gap:12px;align-items:start}.detail-column{display:grid;gap:8px;align-items:start}
    ...
    @media(max-width:1050px){.layout{grid-template-columns:1fr}.form-grid,.form-grid.compact{grid-template-columns:repeat(2,minmax(0,1fr))}.form-grid.compact .note-field{grid-column:span 1}}
