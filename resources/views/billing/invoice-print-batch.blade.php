...
<head>
  ...
  <style>
    ...
    @media print{body{margin:0}.no-print{display:none}.invoice-page{break-after:page;page-break-after:always}.invoice-page:last-child{break-after:auto;page-break-after:auto}}
  </style>
</head>
<body>
  <button class="no-print" onclick="window.print()">まとめて印刷 / PDF保存</button>
