...
let closeRows=[];async function loadClose(){const y=document.getElementById('close-year').value,m=document.getElementById('close-month').value;const d=await api(`/api/v1/monthly-closing/stock-balances?year=${y}&month=${m}`);closeRows=d.stock_monthly_balances||[];renderClose()}
